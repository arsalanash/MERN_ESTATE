...
export const signup = async (req, res, next) => {
    ...
    try {
        ...
        if (existingUser) {
            throw errorHandler(409, "Username or email already exists");
        }
...
export const signin = async (req, res, next) => {
    ...
    try {
        ...
        //const { password: pass, ...rest } = validUser._doc;   // another method can be used to avoid extra database call
